...
<head>
    ...
    <title>{{ config('app.name', 'lịch cá nhân') }}</title>
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{ asset('css/utilTable.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('css/mainTable.css') }}">
